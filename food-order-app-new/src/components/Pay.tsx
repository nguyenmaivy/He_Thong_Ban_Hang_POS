...
const Pay: React.FC<PayProps> = ({
  ...
  const [tableNumber, setTableNumber] = useState("A0");
...
const handleSubmit = async () => {
  ...
  try {
    ...
    setErrorMessage(err.message || "Có lỗi xảy ra khi thanh toán.");
  }
};
      ...
      <div className="paymentModal">
        ...
        <div className="container">
          <main className="main">
            ...
            {/* Phần chọn loại đơn hàng */}
            <div className="section_order_type">
              <h2 className="sectionTitle">Loại đơn hàng</h2>
              <div style={{ display: "flex", gap: "1rem" }}>
                <label className={`phuongThuc ${orderType === "dine_in" ? "active" : ""}`}>
                  <input
                    type="radio"
                    name="orderType"
                    value="dine_in"
                  ...
                  />
                  <span className="paymentContent">Dùng tại chỗ</span>
                </label>

                <label className={`phuongThuc ${orderType === "takeaway" ? "active" : ""}`}>
                  <input
                    type="radio"
                    name="orderType"
                    value="takeaway"
                  ...
                  />
                  <span className="paymentContent">Mang đi</span>
                </label>
              </div>
            </div>
